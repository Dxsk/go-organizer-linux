...
export function CharSelectedEvent(arg1:number):Promise<void>;

export function CreateConfigSection(arg1:ini.File,arg2:string):Promise<void>;

export function GetAllKeyBindings():Promise<Record<number, main.Keybinds>>;
...
export function WinActivate(arg1:number):Promise<void>;
